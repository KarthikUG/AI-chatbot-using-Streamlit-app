...
st.header("KUG CHATBOT")
st.sidebar.header("Options")
st.sidebar.write("This is a demo")
max_tokens=st.sidebar.slider("Max Tokens",1,250,100)
st.write(f"{max_tokens}")
temperature=st.sidebar.slider("Temperature",0.0,1.0,0.7)
system_message_type=st.sidebar.selectbox("System Message",("KUG Assistant","Angry Assistant","Custom"))

SYSTEM_PROMPT = "You are a helpful assistant."

# Update SYSTEM_PROMPT based on selection
if system_message_type == "KUG Assistant":
    SYSTEM_PROMPT = "You are a KUG assistant that is fed up with answering questions."
    ...
    # Provide default and allow user input
    custom_prompt = st.sidebar.text_area("Custom System Message", "Enter your custom system message here.")
    if custom_prompt.strip() != "":
        SYSTEM_PROMPT = custom_prompt

# Show current prompt
st.subheader("System Prompt in Use:")
